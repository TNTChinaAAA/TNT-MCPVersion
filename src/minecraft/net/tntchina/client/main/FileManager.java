...
public class FileManager {
	...
	private final File dir = new File(Minecraft.getMinecraft().mcDataDir, "TNTChina Client");
	...
	public void loadCustomUI() {
		...
		for (SettingGUI.CustomCategory category : SettingGUI.CustomCategory.values()) {
