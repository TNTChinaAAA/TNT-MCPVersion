...
import static net.tntchina.client.module.modules.render.hud.HUDValueManager.array_right;
import static net.tntchina.client.module.modules.render.hud.HUDValueManager.array_size;
import static net.tntchina.client.module.modules.render.hud.HUDValueManager.array_x;
import static net.tntchina.client.module.modules.render.hud.HUDValueManager.array_y;
import static net.tntchina.client.module.modules.render.hud.HUDValueManager.tabgui_right;
import static net.tntchina.client.module.modules.render.hud.HUDValueManager.tabgui_x;
import static net.tntchina.client.module.modules.render.hud.HUDValueManager.tabgui_y;
import static net.tntchina.client.module.modules.render.hud.HUDValueManager.title_right;
import static net.tntchina.client.module.modules.render.hud.HUDValueManager.title_size;
import static net.tntchina.client.module.modules.render.hud.HUDValueManager.title_x;
import static net.tntchina.client.module.modules.render.hud.HUDValueManager.title_y;
...
import net.tntchina.client.clickgui.ClickGui;
...
import net.tntchina.client.event.events.Render2DEvent;
import net.tntchina.client.font.CFontRenderer;
import net.tntchina.client.font.UnicodeFontRenderer;
...
import net.tntchina.client.tabgui.Tab;
import net.tntchina.client.tabgui.TabButton;
...
public class HUD extends Module {
	...
	public void onStart(ClientPostStartingEvent event) {
		...
		this.defaultRendererObj = new UnicodeFontRenderer(new Font("\u534e\u6587\u4eff\u5b8b", Font.BOLD, 14));
		
		if (!Strings.isEmpty(TNTChina.getFileManager().fontLoaderPath)) {
			Font f = null;
			
			try {
				f = Font.createFont(0, new File(TNTChina.getDir(), TNTChina.getFileManager().fontLoaderPath)).deriveFont(0, array_size.getIntValue());
			} catch (Exception e) {
				return;
			}
	...
	private void renderHotBar() {
		...
		String cnm = this.mc.thePlayer.getHeldItem() == null ? "Hand" : this.mc.thePlayer.getHeldItem().getDisplayName();
		String message = "HeldItem: ";
		this.defaultRendererObj.drawString(message, len, y + 2, HUD.rainbow(index.get() * 400));
		len += this.defaultRendererObj.getStringWidth(message);
		this.defaultRendererObj.drawString(cnm, len, y + 2, -1);
		len += this.defaultRendererObj.getStringWidth(cnm + "   ");
		index.getAndIncrement();
	...
	public void renderPostion(AtomicInteger index) {
		...
		this.defaultRendererObj.drawString(TNTChina.CLIENT_NAME + " " + TNTChina.CLIENT_VERSION + " - by " + TNTChina.CLIENT_AUTHOR, x, y, HUD.rainbow(index.get() * 400));
		index.getAndIncrement();
	}
	...
	private void onRender(Render2DEvent event) {
		...
		if (this.mc.currentScreen != null) {
			if (!(this.mc.currentScreen instanceof ClickGui | this.mc.currentScreen instanceof SettingGUI)) {
				this.makeRender();
			}
		} else {
			this.makeRender();
		...
		GL11.glPushMatrix();
		String name = TNTChina.CLIENT_NAME + TNTChina.SPACE + "V" + TNTChina.CLIENT_VERSION;
