package net.tntchina.client.module;

import java.util.*;
import net.minecraft.client.Minecraft;
import net.minecraft.client.gui.FontRenderer;
import net.tntchina.client.module.modules.combat.*;
import net.tntchina.client.module.modules.exploit.*;
import net.tntchina.client.module.modules.misc.*;
import net.tntchina.client.module.modules.movement.*;
import net.tntchina.client.module.modules.player.*;
import net.tntchina.client.module.modules.render.*;
import net.tntchina.client.module.modules.world.*;
...
public class ModuleManager {
	...
	public ModuleManager() {
		...
		this.registerModule(new NameProject("NameProject", ModuleCategory.MISC));
		...
		this.registerModule(new TPAura("TPAura", ModuleCategory.COMBAT));
		...
		this.registerModule(new Tower("Tower", ModuleCategory.WORLD));
		this.registerModule(new NotViewBob("NotViewBob", ModuleCategory.RENDER));
		this.registerModule(new SnowFly("SnowFly", ModuleCategory.MOVEMENT));
		...
		this.registerModule(new SafeWalk("SafeWalk", ModuleCategory.MOVEMENT));
		...
		this.registerModule(new NoBanIP("NoBanIP", 0, ModuleCategory.MISC));
		...
		this.registerModule(new BugUp("BugUp", 48, ModuleCategory.MOVEMENT));
		...
		this.registerModule(new AntiBot("AntiBot", ModuleCategory.COMBAT));
		...
		this.registerModule(new AimBot("AimBot", ModuleCategory.COMBAT));
		...
		this.registerModule(new LiquidWalk("LiquidWalk", ModuleCategory.MOVEMENT));
		...
		this.registerModule(new ItemUnbreakable("ItemUnbreakable", ModuleCategory.EXPLOIT));
		this.registerModule(new AutoArmor("AutoArmor", ModuleCategory.PLAYER));
		this.registerModule(new AutoBlock("AutoBlock", ModuleCategory.PLAYER));
		this.registerModule(new FastBow("FastBow", ModuleCategory.PLAYER));
		this.registerModule(new Triggerbot("Triggerbot", ModuleCategory.COMBAT));
		this.registerModule(new BowAimbot("BowAimBot", ModuleCategory.COMBAT));
