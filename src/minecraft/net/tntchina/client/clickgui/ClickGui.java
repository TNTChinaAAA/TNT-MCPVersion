...
import net.tntchina.client.clickgui.module.ModuleButton;
import net.tntchina.client.clickgui.module.ModulePanel;
...
import net.tntchina.client.clickgui.other.ModeButton;
import net.tntchina.client.clickgui.other.ModeValueButton;
			...
			for (Module m : ModuleManager.getModules()) {
				if (m.getCategory().equals(category)) {// 功能和Category是否同一类型
					...
					if (option.getButtons().size() > 0) {
						...
						TNTChina.getLogger().info(m.getName() + " has options.");
					}
