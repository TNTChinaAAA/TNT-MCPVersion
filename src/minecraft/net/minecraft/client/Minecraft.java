...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public static final ResourceLocation locationMojangPng = new ResourceLocation("textures/gui/title/mojang.png");
    public static final boolean isRunningOnMac = Util.getOSType() == Util.EnumOS.OSX;

    /** A 10MiB preallocation to ensure the heap is reasonably sized. */
    public static byte[] memoryReserve = new byte[10485760];
    public static final List<DisplayMode> macDisplayModes = Lists.newArrayList(new DisplayMode[] {new DisplayMode(2560, 1600), new DisplayMode(2880, 1800)});
    public final File fileResourcepacks;
    public final PropertyMap twitchDetails;
    public final PropertyMap field_181038_N;
    ...
    public final Thread mcThread = Thread.currentThread();
    ...
    public void createDisplay() throws LWJGLException
    {
		...
		Display.setTitle(TNTChina.getFullName());
	...
	public void setWindowIcon() {
		...
		if (util$enumos != Util.EnumOS.OSX) {
			InputStream inputStream = Util.class.getResourceAsStream("/assets/tnt/icon_16x16.png");
			InputStream inputStream1 = Util.class.getResourceAsStream("/assets/tnt/icon_32x32.png");

			try {
				ByteBuffer buffer = this.readImageToBuffer(inputStream);
				ByteBuffer buffer1 = this.readImageToBuffer(inputStream1);
				Display.setIcon(new ByteBuffer[] { buffer, buffer1 });
			} catch (IOException e) {
				e.printStackTrace();
			} finally {
    ...
    public void rightClickMouse()
    {
        ...
        {
            this.rightClickDelayTimer = ModuleManager.getModuleState(FastPlace.class) ? 1 : 4;
            boolean flag = true;
    ...
    public void setDimensionAndSpawnPlayer(int dimension)
    {
        ...
        this.thePlayer.getDataWatcher().updateWatchedObjectsFromList(this.thePlayer.getDataWatcher().getAllWatched());
        ...
        this.playerController.setPlayerCapabilities(this.thePlayer);
        this.thePlayer.setReducedDebug(this.thePlayer.hasReducedDebug());
    ...
    public ItemStack func_181036_a(Item p_181036_1_, int p_181036_2_, TileEntity p_181036_3_)
    {
