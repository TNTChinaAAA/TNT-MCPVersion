...
import net.tntchina.client.module.modules.exploit.CanPVP;
import net.tntchina.client.module.modules.misc.NoBanIP;
import net.tntchina.inject.IEntityPlayerMP;

import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;

public class EntityPlayerMP extends EntityPlayer implements ICrafting, IEntityPlayerMP
{
    ...
    {
    	if (ModuleManager.getModuleState(NoBanIP.class) && this.isServer()) {
			return "2938298.223.2323";
		}
